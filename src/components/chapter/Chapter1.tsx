    ...
    <div>
      <div>
        <p>
          ...
          through the rain. Your hands grip the thick iron cable of the Wire
          Road, pulled taut through rings sunken into the trunks of hideous
          trees. For days now, it has been the only evidence of humanity's
          existence in the Deepwood. You have lost one member of your group on
          the journey so far. The sound of the thrum as Samil was plucked from
          the Wire is still fresh in your mind.
        </p>
        <p>
          The fortress town of Bastone looms before you, its ancient gray walls
          battered by the rain. People have been dying here and you have
          ...
          area manned by a grim-faced guard. "Oathsworn. Heard you were coming.
          We found more bodies last night. Make your mark and enter."
        </p>
      </div>
      <div>
      ...
      <div>
        <p>
          ...
          calls himself the 'Mayor of Bastone. He convinces you to hire him to
          act as your guide during your stay here.
        </p>
      </div>
      <div>
        <p>
      ...
      <div>
        ...
        <p>
          ...
          green Bram, especially if they're supposed to be yellow." He turns to
          you with a wry smile, "Greycane is the name. I'm the eyes and ears of
          this town."
        </p>
        <p>
      ...
      <div>
        <p>
          ...
          you find the body collector with his hungry family. "You need words,
          we need food. Iron helps," he bargains.
        </p>
      </div>
      <div>
        <p>
          PERFORM A BARTERING CHECK (DIFFICULTY 7). BEFORE YOU DRAW, YOU CAN
          SPEND ANY AMOUNT OF IRON TO REDUCE THE DIFFICULTY OF THIS CHECK BY THE
          SAME AMOUNT.
        </p>
      </div>
      <div>
      ...
      <div>
        <p>
          ...
          bodies off the wall for weeks now, but she's still alive!" As you look
          over the crenelations, you see a pack of rat-like creatures crawl from
          the Deepwood and drag a woman out of a pile of corpses below.
        </p>
      </div>
      <div>
        <p>
      ...
      <div>
        <p>
          ...
          the woman, torn and bloody before you. The rotten stench of death and
          decay assaults your senses as you glimpse the movement of a hulking
          shape stirring in the shadows. The massive body of a Broodmother steps
          into the clearing, her great head of rotten fur and gnawing teeth
          rolls toward you with ravenous hunger as her eyes meet yours.
        </p>
      </div>
      <div>
