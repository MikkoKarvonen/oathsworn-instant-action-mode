  ...
  const sections = [
    <>
      <p>
        ...
        quarantined Cobbles over the walls of the outer city ring. The plague
        has worsened and rumors abound that it is not just killing people now,
        it is also changing them.
      </p>
    </>,
    <>
      <p>
    ...
    <>
      ...
      <p>
        ...
        surrounded by uncounted monsters, and unless we can defeat them, we are
        without hope. 'Heroes of Bastone, tell us of The Keening."
      </p>
      <p>
        ...
        Keening of the witch was like a beacon to the creatures of the forest,
        and how they were drawn from miles around by her psychic howl.
      </p>
      <p>
        Nodding, the King raises his voice above the crowd. "This is our path.
        If we can draw the creatures from the heart using this Keening, we could
        save Verum. I hereby order each Free Company in the realm to hunt and
        collar every witch they can find. It is a bloody task, but I am certain
        if we do not take it, we will be ensuring the death of thousands, and
        the loss of our great city. You have until the new moon. At that time,
        we shall march into the Heart of Darkness, witches or not. We have only
        one chance to succeed. Failure is not an option."
      </p>
    </>,
    <>
      <p>CHOOSE EITHER:</p>
    ...
    <>
      <p>
        ...
        witches at present, but tells you of a recent sighting. It seems another
        Free Company had been on the trail of a witch several days before, but
        has missing. If only you can track them down. gone
      </p>
    </>,
    <>
      <p>
        PERFORM A REASONING CHECK (DIFFICULTY 5). ADD 1 TO THE RESULT IF THE
        WARDEN IS WITH YOU. IF YOU SUCCEED, ALL OATHSWORN GAIN AN EMPOWERED x3
        TOKEN FOR OBTAINING THE INFORMATION QUICKLY.
      </p>{" "}
    </>,
    <>
      <p>
        ...
        escaped witch whose last sighting was in The Cobbles.
      </p>
      <p>
        With the fate of the city at stake, you put a cloth to your mouth and
        enter the quarantine zone. The plague is known to be passed by touch, so
        long as you keep your distance from the infected you should be okay.
      </p>
    </>,
    <>
      <p>
        PERFORM A SEARCH CHECK (DIFFICULTY 4). IF YOU SUCCEED, ALL OATHSWORN
        GAIN A +2 ANIMUS TOKEN FOR SPENDING AS LITTLE TIME AS POSSIBLE OUTSIDE.
      </p>{" "}
    </>,
    <>
      <p>
      ...
      <p>
        Just as you are about to return to the search, the door is broken down
        by an abomination, thick black roots and bark spread over her body as
        she lumbers forward, reaching out to touch you. You have seen this
        before in Brother Marius, you cannot let her touch you.
      </p>
    </>,
    <>
    ...
    <>
      <p>
        ...
        The quarantine is broken, the inner city walls are being attacked. You
        need to help defend the city.
      </p>
    </>,
    <>
      <p>CHOOSE EITHER:</p>
    ...
    <>
      <p>
        PERFORM A SURVIVAL CHECK (DIFFICULTY 7). IF YOU SUCCEED, WRITE 'PLAGUE
        STAGE 1' ON YOUR FREE COMPANY SHEET. IF YOU FAIL, WRITE 'PLAGUE STAGE 2'
        ON YOUR FREE COMPANY SHEET.
      </p>
    </>,
    <>
      <p>
        ...
        being put to the torch and flames shoot up in the sky. The north side of
        the city is lost.
      </p>
      <p>
        Through the chaos, you see a woman behind the horde, fire spewing from
        her hands, driving the infected before her. She is responsible for the
        attack. Beside her, you make out a Free Company, the Stone Dogs. Their
        eyes are hazy, and they are clearly under some malefic power.
      </p>
    </>,
    <>
      <p>
        PERFORM A SPOT CHECK (DIFFICULTY 5). ADD 1 TO YOUR RESULT IF THE WITCH
        IS WITH YOU. IF YOU SUCCEED, MARK THE ENCOUNTER SPECIAL RULES BOARD BOX
        FOR CHAPTER 13 ON YOUR FREE COMPANY SHEET.
      </p>
    ...
    <>
      ...
      <p>
        ...
        continue to ring throughout the city. Half the city was lost today, and
        although you secured the escape of many, there was no escape for you,
        you too are now infected. Sitting on a barrel north of the river, you
        watch the river burn.
      </p>
    </>,
    <>
      ...
      <p>
        ...
        OATHSWORN, MARK THE EXTRA UNIQUE ITEM BOX FOR CHAPTER 13 ON YOUR FREE
        COMPANY SHEET.
      </p>
